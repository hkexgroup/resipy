...
#        flag_sort=np.delete(flag_sort,cache_idx).tolist()
    ...
    original_idx = (elec_x_cache == original_x) & (elec_z_cache == original_z)
    node_pos = node_pos[original_idx]
...
nodes,_ = genGeoFile(electrodes, typ,geom_input)   

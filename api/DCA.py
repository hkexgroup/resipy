...
#    if 'M1' not in data.columns:
#        print('No decay curves were found in dataset\nExtract the data from "Prosys" with M1, M2, ... , M20 and TM1 tabs enabled!')
#        return
#    elif all(['M1','M2','M3','M4','M5','M6','M7','M8','M9','M10','M11','M12','M13','M14','M15','M16','M17','M18','M19','M20', 'TM1']) not in data.columns:
#        print('Incomplete set of decay curves!\nExtract the data from "Prosys" with M1, M2, ... , M20 and TM1 tabs enabled!')
#        return

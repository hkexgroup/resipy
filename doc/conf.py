...
example_gallery_config = {
    ...
    'dont_preprocess': ['../jupyter-notebook/nb_Morris.ipynb',
     ...
     '../jupyter-notebook/nb_3d-pseudo3dsurvey.ipynb',
     '../jupyter-notebook/nb_3d-timelapse.ipynb',
     '../jupyter-notebook/nb_3d-from-2d-lines.ipynb'], # all 3D notebooks are note well handled by sphinx and pyvista on docker image (causes kernel to crash) - but works fine locally
    'pattern': 'nb_.+.ipynb',

...
a = Analysis(['ui.py'],
             ...
             binaries=[],
             datas=datas,
             hiddenimports=['pkg_resources.py2_warn', 'vtkmodules', 'vtkmodules.all', 'vtkmodules.util.numpy_support', 'vtkmodules.numpy_interface', 'vtkmodules.numpy_interface.dataset_adapter'],
             hookspath=[],
             runtime_hooks=[],
             excludes=[],

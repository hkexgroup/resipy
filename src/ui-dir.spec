...
a = Analysis(['ui.py'],
             ...
             datas = datas,
             hiddenimports=[
                'pkg_resources.py2_warn','vtkmodules.all',
                'vtk.util.numpy_support','vtkmodules.util.numpy_support',
                'vtkmodules.qt.QVTKRenderWindowInteractor','scipy._lib.array_api_compat.numpy.fft',
                'scipy.special._special_ufuncs', 'scipy._cyutility'],
             hookspath=[],
